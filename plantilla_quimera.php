<?php
// ARCHIVO: plantilla_quimera.php (v4.1 - Definitiva)
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        #main-nav {
            position: fixed; top: 16px; left: 16px; height: calc(100vh - 32px); width: var(--nav-width-collapsed);
            background: var(--c-glass-bg); backdrop-filter: blur(var(--blur-heavy));
            border: 1px solid var(--c-glass-border); border-radius: var(--radius-xl); padding: 24px 0;
        ...
        .nav-link {
            ...
            color: var(--c-text-secondary); text-decoration: none; font-weight: 600; font-size: 1rem;
